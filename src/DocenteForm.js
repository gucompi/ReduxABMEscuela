              ...
              <form className="agregar" onSubmit={this.handleSubmit} >
                  ...
                  <div className="modal-body">	
                      ...
                      <div className="form-group">
                          ...
                          {this.props.cursos.map((curso)=>{return ( <div className="form-check" key={curso.id} id={curso.id} onClick={this.handleClick}> <input type="checkbox" className="form-check" checked={this.state.cursosDocente.indexOf(curso.id)!=-1} value={curso.id} id={curso.id}></input> <label id={curso.id} className="form-check" htmlFor={curso.id}>{curso.anio}-{curso.turno}</label></div>)})}
                      </div>
                  </div>
